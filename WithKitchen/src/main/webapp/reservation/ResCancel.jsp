...
<body>
	...
	<symbol id="exclamation-triangle-fill" viewBox="0 0 16 16"> <path
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content rounded-4 shadow">
				...
				<div class="modal-footer flex-column border-top-0">
					<button type="button"
						class="btn btn-lg btn-primary w-100 mx-0 mb-2" value="예"
						onclick="location.href='/WithKitchen/reservation/ResCancelOk.jsp'">예</button>
					<button type="button" class="btn btn-lg btn-light w-100 mx-0"
						data-bs-dismiss="modal" value="아니오"
						onclick="location.href='/WithKitchen/reservation/ReservationCheck.jsp'">아니오</button>
				</div>
			</div>
		</div>
	</div>

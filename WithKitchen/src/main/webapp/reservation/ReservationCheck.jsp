 ...
 <hr class="my-4">
          ...
          <h4 class="mb-3">거북이의 주방</h4>
                ...
                <li>  <div id="button">
                    ...
                    <a href="https://map.naver.com/v5/entry/place/35915198?c=14130189.6387539,4516626.5850942,15,0,0,0,dh.html"><input type="button"  class="btn btn-outline-success" value="길찾기"></a><br>
                    <img src="" alt="">
                </div>
                </li>
            </ul>
          ...
          <button class="w-50 btn btn-outline-secondary btn-lg" type="button"  value="예" onclick="location.href='/WithKitchen/reservation/ResCancel.jsp'">취소하기</button>
